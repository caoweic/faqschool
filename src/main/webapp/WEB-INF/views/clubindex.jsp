        ...
        <div class="main layui-clear">
            <div class="wrap">
                <div class="content">
                    <div class="fly-tab">
                        <span>
                          <a href="/club/index">全部问题</a>
                          <a href="/club/index?type=unresolved">未结问题</a>
                          <a href="/club/index?type=resolved">已采纳问题</a>
                          <a href="/club/index?type=wonderful">精华问题</a>
                        </span>
                            ...
                            <ul>
                                ...
                                <li class="fly-list-li">
                                    ...
                                    <h2 class="fly-tip">
                                        ...
                                        {{ item.status == 1 ? '<span class="fly-tip-jing">精华问题</span>' : ''}}
                                    </h2>
                                    <p>
                                        <span><a href="#">{{ item.user.name }}</a></span>
                                        <span>{{item.time}} </span>
                                        <span>湖北理工学院数理学院</span>
